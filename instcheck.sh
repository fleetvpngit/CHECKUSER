...
echo ""
echo -e "                 \033[1;31mBy @SCRIPTPLUS\033[1;36m"
echo ""
...
sleep 5
cd /bin || exit
wget https://raw.githubusercontent.com/fleetvpngit/CHECKUSER/main/chuser > /dev/null 2>&1
wget https://raw.githubusercontent.com/fleetvpngit/CHECKUSER/main/userscheck > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/fleetvpngit/CHECKUSER/main/checkuser.py > /dev/null 2>&1
